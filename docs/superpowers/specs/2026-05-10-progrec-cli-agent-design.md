...
The agent should be implemented as a new package directory `progrec_agent/` that acts as a lightweight orchestration layer above the existing five skills.
...
- a user can launch `python -m progrec_agent.repl`
