# StuRec CLI Agent Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build a CLI-first StuRec agent that orchestrates Skills 1-5 for dataset-backed and manual student profiles, supports a small REPL command set, and returns explainable mentor/project/teammate recommendations.

**Architecture:** Add a new `sturec_agent/` package that owns REPL flow, session state, rendering, and orchestration while preserving the five existing skills as separate modules. Prefer direct Python integration for Skill 3 and Skill 4, lightweight adapters for Skill 1 and Skill 2, and a subprocess wrapper for Skill 5's final ranking script.
...
**Files:**
- Create: `sturec_agent/__init__.py`
- Create: `sturec_agent/models.py`
- Create: `sturec_agent/session.py`
- Test: `tests/test_sturec_agent_session.py`
...
Run: `python3 -m pytest tests/test_sturec_agent_session.py -q`

Expected: FAIL with `ModuleNotFoundError: No module named 'sturec_agent'`
...
from sturec_agent.models import JsonDict, Mode, PipelineArtifacts
...
```bash
git add sturec_agent/__init__.py sturec_agent/models.py sturec_agent/session.py tests/test_sturec_agent_session.py
git commit -m "feat: add StuRec agent session scaffolding"
```

### Task 2: Implement Skill 1 and Skill 2 adapters

**Files:**
- Create: `sturec_agent/adapters/__init__.py`
- Create: `sturec_agent/adapters/skill1_adapter.py`
- Create: `sturec_agent/adapters/skill2_adapter.py`
- Test: `tests/test_sturec_agent_adapters.py`
...
Run: `python3 -m pytest tests/test_sturec_agent_adapters.py -q`
...
```bash
git add sturec_agent/adapters/__init__.py sturec_agent/adapters/skill1_adapter.py sturec_agent/adapters/skill2_adapter.py tests/test_sturec_agent_adapters.py
git commit -m "feat: add StuRec agent skill adapters"
```

### Task 3: Implement Skill 3, Skill 4, and Skill 5 wrappers plus dataset-mode orchestration

**Files:**
- Create: `sturec_agent/adapters/skill3_adapter.py`
- Create: `sturec_agent/adapters/skill4_adapter.py`
- Create: `sturec_agent/adapters/skill5_adapter.py`
- Create: `sturec_agent/orchestrator.py`
- Test: `tests/test_sturec_agent_orchestrator.py`
...
Run: `python3 -m pytest tests/test_sturec_agent_orchestrator.py -q`

Expected: FAIL because `StuRecOrchestrator` does not exist yet
...
```bash
git add sturec_agent/adapters/skill3_adapter.py sturec_agent/adapters/skill4_adapter.py sturec_agent/adapters/skill5_adapter.py sturec_agent/orchestrator.py tests/test_sturec_agent_orchestrator.py
git commit -m "feat: add dataset-mode StuRec orchestration"
```

### Task 4: Add custom-profile mode and shared recommendation entrypoint

**Files:**
- Modify: `sturec_agent/adapters/skill4_adapter.py`
- Modify: `sturec_agent/orchestrator.py`
- Test: `tests/test_sturec_agent_custom_mode.py`
...
Run: `python3 -m pytest tests/test_sturec_agent_custom_mode.py -q`
...
```bash
git add sturec_agent/adapters/skill4_adapter.py sturec_agent/orchestrator.py tests/test_sturec_agent_custom_mode.py
git commit -m "feat: add custom-profile StuRec orchestration"
```

### Task 5: Add terminal rendering and REPL commands

**Files:**
- Create: `sturec_agent/render.py`
- Create: `sturec_agent/repl.py`
- Test: `tests/test_sturec_agent_repl.py`
...
Run: `python3 -m pytest tests/test_sturec_agent_repl.py -q`
...
```bash
git add sturec_agent/render.py sturec_agent/repl.py tests/test_sturec_agent_repl.py
git commit -m "feat: add StuRec CLI interaction layer"
```
...
**Files:**
- Modify: `README.md`
- Test: `tests/test_sturec_agent_integration.py`
...
Run: `python3 -m pytest tests/test_sturec_agent_integration.py -q`
...
```python
# tests/test_sturec_agent_integration.py
...
- the `python3 -m sturec_agent.repl` entrypoint
- the two input modes
...
Run: `python3 -m pytest tests/test_sturec_agent_session.py tests/test_sturec_agent_adapters.py tests/test_sturec_agent_orchestrator.py tests/test_sturec_agent_custom_mode.py tests/test_sturec_agent_repl.py tests/test_sturec_agent_integration.py -q`
...
```bash
git add README.md tests/test_sturec_agent_integration.py
git commit -m "docs: document StuRec CLI agent usage"
```
