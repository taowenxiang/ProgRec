# StuRec AI Agent Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Turn `sturec_agent` from a fixed CLI wrapper into a natural-language, LLM-driven tool-using AI agent with clarification, planning, bounded reruns, and decision traces.

**Architecture:** Add an agent layer inside `sturec_agent/` that sits between the CLI and the existing skill adapters. Keep Skills 3 to 5 as the recommendation core, while the new layer owns intent understanding, structured profile enrichment, tool planning, strategy adjustment, result judging, and explanation rendering.

**Tech Stack:** Python 3, stdlib `unittest`, existing `sturec_agent` package, existing skill adapters, external LLM API over HTTPS via stdlib `urllib` or `http.client`
...
- Create: `sturec_agent/agent_schema.py`
- Create: `sturec_agent/llm_client.py`
- Create: `sturec_agent/prompts.py`
- Create: `sturec_agent/profile_enricher.py`
- Create: `sturec_agent/strategy.py`
- Create: `sturec_agent/result_judge.py`
- Create: `sturec_agent/tools.py`
- Create: `sturec_agent/planner.py`
- Create: `sturec_agent/explainer.py`
- Create: `sturec_agent/tests/test_agent_schema.py`
- Create: `sturec_agent/tests/test_llm_client.py`
- Create: `sturec_agent/tests/test_profile_enricher.py`
- Create: `sturec_agent/tests/test_strategy.py`
- Create: `sturec_agent/tests/test_result_judge.py`
- Create: `sturec_agent/tests/test_tools.py`
- Create: `sturec_agent/tests/test_planner.py`
- Create: `sturec_agent/tests/test_repl_agent_flow.py`

### Existing files to modify

- Modify: `sturec_agent/models.py`
- Modify: `sturec_agent/session.py`
- Modify: `sturec_agent/orchestrator.py`
- Modify: `sturec_agent/render.py`
- Modify: `sturec_agent/repl.py`
- Modify: `README.md`
...
- Keep stable: `sturec_agent/config.py`
- Keep stable: `sturec_agent/schemas.py`
...
- Modify: `sturec_agent/models.py`
- Modify: `sturec_agent/session.py`
- Test: `sturec_agent/tests/test_agent_schema.py`
...
Run: `python3 -m unittest sturec_agent.tests.test_agent_schema -v`  
Expected: FAIL with `ModuleNotFoundError` for `sturec_agent.agent_schema` or missing `AgentSession` fields.
...
```bash
git add sturec_agent/agent_schema.py sturec_agent/models.py sturec_agent/session.py sturec_agent/tests/test_agent_schema.py
...
- Create: `sturec_agent/llm_client.py`
- Create: `sturec_agent/prompts.py`
- Test: `sturec_agent/tests/test_llm_client.py`
...
Run: `python3 -m unittest sturec_agent.tests.test_llm_client -v`  
Expected: FAIL with `ModuleNotFoundError` for `sturec_agent.llm_client`.
...
```bash
git add sturec_agent/llm_client.py sturec_agent/prompts.py sturec_agent/tests/test_llm_client.py
...
- Create: `sturec_agent/profile_enricher.py`
- Create: `sturec_agent/strategy.py`
- Test: `sturec_agent/tests/test_profile_enricher.py`
- Test: `sturec_agent/tests/test_strategy.py`
...
Run: `python3 -m unittest sturec_agent.tests.test_profile_enricher sturec_agent.tests.test_strategy -v`  
...
```bash
git add sturec_agent/profile_enricher.py sturec_agent/strategy.py sturec_agent/tests/test_profile_enricher.py sturec_agent/tests/test_strategy.py
...
- Create: `sturec_agent/tools.py`
- Modify: `sturec_agent/orchestrator.py`
- Test: `sturec_agent/tests/test_tools.py`
...
Run: `python3 -m unittest sturec_agent.tests.test_tools -v`  
Expected: FAIL with `ModuleNotFoundError`.
...
Run: `python3 -m unittest sturec_agent.tests.test_tools sturec_agent.tests.test_orchestrator_graph_skill3 -v`  
Expected: PASS

- [ ] **Step 6: Commit**

```bash
git add sturec_agent/tools.py sturec_agent/orchestrator.py sturec_agent/tests/test_tools.py
...
- Create: `sturec_agent/result_judge.py`
- Create: `sturec_agent/planner.py`
- Test: `sturec_agent/tests/test_result_judge.py`
- Test: `sturec_agent/tests/test_planner.py`
...
Run: `python3 -m unittest sturec_agent.tests.test_result_judge sturec_agent.tests.test_planner -v`  
Expected: FAIL with `ModuleNotFoundError`.
...
```bash
git add sturec_agent/result_judge.py sturec_agent/planner.py sturec_agent/tests/test_result_judge.py sturec_agent/tests/test_planner.py
...
- Modify: `sturec_agent/render.py`
- Modify: `sturec_agent/session.py`
- Test: `sturec_agent/tests/test_repl_agent_flow.py`
...
Run: `python3 -m unittest sturec_agent.tests.test_repl_agent_flow -v`  
...
```bash
git add sturec_agent/repl.py sturec_agent/render.py sturec_agent/session.py sturec_agent/tests/test_repl_agent_flow.py
...
Run: `python3 -m unittest sturec_agent.tests.test_planner sturec_agent.tests.test_repl_agent_flow -v`  
...
Run: `python3 -m unittest discover -s sturec_agent/tests -v`  
Expected: PASS

- [ ] **Step 6: Commit**

```bash
git add sturec_agent/explainer.py sturec_agent/orchestrator.py sturec_agent/render.py sturec_agent/tests/test_planner.py sturec_agent/tests/test_repl_agent_flow.py
...
Run: `python3 -m sturec_agent.repl`  
